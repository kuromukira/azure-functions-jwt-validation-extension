...
namespace Microsoft.Azure.Functions.Extensions.JwtCustomHandler
{
    ...
    public sealed class AccessTokenResult
    {
        ...
        public static AccessTokenResult Success(ClaimsPrincipal principal) => new AccessTokenResult
        {
            Principal = principal,
        ...
        public static AccessTokenResult Expired() => new AccessTokenResult
        {
        ...
        public static AccessTokenResult Error(Exception ex) => new AccessTokenResult
        {
        ...
        public static AccessTokenResult NoToken() => new AccessTokenResult
        {
